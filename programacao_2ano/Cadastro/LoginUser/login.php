<?php
		...
		if (isset($_POST['tBtn'])) {
			$txtCPF = mysqli_escape_string($_POST['tCPF']);
			$txtSenha = mysqli_escape_string(md5($_POST['tSenha']));
			...
			if (mysqli_num_rows($txtResult) > 0) {
				...
				echo "<script language='javascript' type='text/javascript'>alert('Credenciais incorretos'); window.location.href='login.php'</script";
